...
epochs_val=30
imageDimesions = (300,300,32)
testRatio = 0.2    # if 1000 images split will 200 for testing # 1 Better
validationRatio = 0.2 # if 1000 images 20% of remaining 800 will be 160 for validation # 1 Better
...
pickle_out= open("model_trained.p","wb")  # wb Meand WRITE BYTE
